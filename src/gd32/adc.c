...
static const uint8_t adc_pin[] = {
    GPIO('A', 0), GPIO('A', 1),       GPIO('A', 2), GPIO('A', 3), GPIO('A', 4),
    GPIO('A', 5), GPIO('A', 6),       GPIO('A', 7), GPIO('B', 0), GPIO('B', 1),
    GPIO('C', 0), GPIO('C', 1),       GPIO('C', 2), GPIO('C', 3), GPIO('C', 4),
    GPIO('C', 5), ADC_TEMPERATURE_PIN};
...
static void adcRegularChannelConfig(uint8_t rank, uint8_t channel,
