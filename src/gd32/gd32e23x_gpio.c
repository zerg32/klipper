...
uint32_t gpio_port_base[] = {GPIOA, GPIOB, GPIOC, 0, 0, GPIOF};

uint32_t gpio_pclk[] = {RCU_GPIOA, RCU_GPIOB, RCU_GPIOC, 0, 0, RCU_GPIOF};
#endif
...
struct gpio_in gpio_in_setup(uint8_t pin, uint8_t pull_up) {
